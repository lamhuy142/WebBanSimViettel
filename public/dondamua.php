										...
										if ($dh["MaND"] == $_SESSION["nguoidung"]["MaND"] && $dhct["MaS"] == $s["MaSim"] && $dhct["MaDH"] == $dh["MaDH"]) { ?>
											<tr class="table_row">
												...
												<?php if ($dh["TrangThai"] == 0) { ?>
													...
													<td>
														<div class="col">
															<a style="font-family: 'Tilt Neon', sans-serif !important;" href="index.php?action=huydon&id=<?php echo $dh['MaDH']; ?>&idsim=<?php echo $s['MaSim']; ?>&TrangThai=<?php echo $dh['TrangThai']; ?>" class="btn btn-secondary">Hủy đơn</a>
														</div>
													</td>
